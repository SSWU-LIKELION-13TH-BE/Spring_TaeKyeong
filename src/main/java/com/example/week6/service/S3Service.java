...
public class S3Service {
    ...
    public String upload(MultipartFile multipartFile) throws IOException {
        ...
        String fileName = dirName + "/" + randomName; //만들어진 dirName 폴더 뒤에 randomName 을 붙인다.
    ...
    // PUT
    public String update(MultipartFile multipartFile, String key) throws IOException {
    ...
    // DELETE
    public String delete(MultipartFile multipartFile, String key) throws IOException {
...
// 랜덤으로 파일, 디렉토리 생성해 키를 만들고 전송할 객체에 이를 담아서 파일과 같이 post함
// post URL을 담아서 리턴해주는 함수
// 이미지 업로드할 것임